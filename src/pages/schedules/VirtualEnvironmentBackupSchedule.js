        ...
        {!this.state.model.interval && (
          <div>
            <div>
              ...
              <InputConvert
                value={this.state.model.startWindowLength}
                factor={1000 * 60}
                onChange={(e) => {
                  this.setState({
                    ...this.state,
        ...
        {this.state.model.interval && (
          <div>
            <div>
              <h3>Frequency [min]</h3>
              <InputConvert
                value={this.state.model.interval.frequency}
                factor={1000 * 60}
                onChange={(e) => {
                  this.setState({
                    ...this.state,
            ...
            <div>
              ...
              <InputTime
                value={this.state.model.interval.startHour}
                onChange={(e) => {
                  this.setState({
                    ...this.state,
                    model: {
            ...
            <div>
              ...
              <InputTime
                value={this.state.model.interval.endHour}
                onChange={(e) => {
                  this.setState({
                    ...this.state,
                    model: {
