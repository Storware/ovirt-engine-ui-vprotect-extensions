...
class Policy extends React.Component {
  constructor (props) {
    ...
    if (this.props.match.params.guid !== 'create') {
      policiesService.getPolicy('vm-backup', this.props.match.params.guid).then(result => {
        this.setState({
          ...this.state,
          model: result
        })
  ...
  handle = (name) => {
    return (e) => {
      this.setState({
        ...
        model: {
          ...this.state.model,
          [name]: e.target && e.target.nodeName === 'INPUT' ? e.target.value : e.value && e.target
        }
      })
    }
  }
      ...
      <div>
        <Accordion multiple activeIndex={this.state.activeIndex}
          ...
          <AccordionTab header='General'>
            <div>
              <h3>Name</h3>
              <InputText value={this.state.model.name} onChange={this.handle('name')} />
            </div>
            <div className={'pt-2'}>
              <h3>Auto remove non-present Virtual Environments</h3>
              <ToggleButton checked={this.state.model.autoRemoveNonPresent}
                onChange={this.handle('autoRemoveNonPresent')} />
            </div>
            <div className={'pt-2'}>
              <h3>Priority</h3>
              <InputText value={this.state.model.priority} type='number' onChange={this.handle('priority')} />
              <Slider value={this.state.model.priority} onChange={this.handle('priority')} />
            </div>
          </AccordionTab>
            ...
            <div>
              ...
              <div className={'d-flex'}>
                <div className={'col'}>
                  ...
                  <Chips value={this.state.model.autoAssignSettings.includeTags} onChange={(e) => {
                    this.setState({
                      ...this.state,
                      model: {
                        ...this.state.model,
                ...
                <div className={'col'}>
                  ...
                  <Chips value={this.state.model.autoAssignSettings.includeRegExps} onChange={(e) => {
                    this.setState({
                      ...this.state,
                      model: {
                        ...this.state.model,
            ...
            <div>
              ...
              <div className={'d-flex'}>
                <div className={'col'}>
                  ...
                  <Chips value={this.state.model.autoAssignSettings.excludeTags} onChange={(e) => {
                    this.setState({
                      ...this.state,
                      model: {
                        ...this.state.model,
                ...
                <div className={'col'}>
                  ...
                  <Chips value={this.state.model.autoAssignSettings.excludeRegExps} onChange={(e) => {
                    this.setState({
                      ...this.state,
                      model: {
                        ...this.state.model,
          ...
          <AccordionTab header='Other'>
            <div>
              <h3>Fail rest of the backup tasks if more than X % of EXPORT tasks already failed</h3>
              <ToggleButton checked={!!this.state.model.failRemainingBackupTasksExportThreshold} onChange={(e) => {
                this.setState({
                  ...this.state,
                  model: {
                    ...this.state.model,
                    failRemainingBackupTasksExportThreshold: e.value ? 50 : null
                  }
                })
              }} />
              {!!this.state.model.failRemainingBackupTasksExportThreshold && <div>
                <h3>Percent of already failed EXPORT tasks</h3>
                <InputText value={this.state.model.failRemainingBackupTasksExportThreshold} type='number'
                  onChange={this.handle('failRemainingBackupTasksExportThreshold')} />
                <Slider value={this.state.model.failRemainingBackupTasksExportThreshold}
                  onChange={this.handle('failRemainingBackupTasksExportThreshold')} />
              </div>}
            </div>
            <div>
              <h3>Fail rest of the backup tasks if more than X % of STORE tasks already failed</h3>
              <ToggleButton checked={!!this.state.model.failRemainingBackupTasksStoreThreshold} onChange={(e) => {
                this.setState({
                  ...this.state,
                  model: {
                    ...this.state.model,
                    failRemainingBackupTasksStoreThreshold: e.value ? 50 : null
                  }
                })
              }} />
              {!!this.state.model.failRemainingBackupTasksStoreThreshold && <div>
                ...
                <Slider value={this.state.model.failRemainingBackupTasksStoreThreshold}
                  onChange={this.handle('failRemainingBackupTasksStoreThreshold')} />
              </div>}
            </div>
          </AccordionTab>
