        ...
        <div className='form'>
            <Accordion multiple activeIndex={activeIndex.first}
                ...
                <AccordionTab header='General'>
                    <div>
                        <h3>Backup policy</h3>
                        <Dropdown value={model.vmBackupPolicy}
                                  optionLabel='name'
                                  dataKey='guid'
                                  options={policies}
                                  onChange={(e) => {
                    ...
                    {policiesService.isSnapshotManagementAvailable(model) && <div>
                      <h3>Snapshot management policy</h3>
                      <Dropdown value={model.snapshotMgmtPolicy}
                                optionLabel='name'
                                dataKey='guid'
                    ...
                    {virtualMachinesService.areSnapshotsFreezable(model) && <div>
                      <h3>Quiesce/freeze before snapshot</h3>
                      <ToggleButton checked={model.quiesceBeforeSnapshot}
                                    onChange={(e) => {
                                        setModel({
                                            ...model,
                    ...
                    {isBaseImageConfigAvailable(model) && <div>
                      <h3>Windows image required</h3>
                      <Dropdown value={model.baseImageCreationConfig.windowsImageRequired}
                                optionLabel='name'
                                dataKey='name'
                    ...
                    {isBaseImageConfigAvailable(model) && <div>
                      ...
                      <Dropdown value={model.baseImageCreationConfig.linuxImageRequired}
                                optionLabel='name'
                                dataKey='name'
                                options={inheritableBooleanValues}
                                onChange={(e) => {
                    ...
                    {!!modes && model.length > 0 && <div>
                      <h3>Export/Import mode</h3>
                      <Dropdown value={model.vmExportImportMode}
                                optionLabel='name'
                                dataKey='name'
                                options={modes}
                                onChange={(e) => {
                ...
                <AccordionTab header='Pre snapshot command execution'>
                  <div>
                    ...
                    <ToggleButton checked={model.preSnapCmdExecEnabled}
                                  onChange={(e) => {
                                      setModel({
                                          ...model,
                    ...
                    <div>
                      <div>
                        ...
                        <Dropdown value={model.preSnapStdErrorHandling}
                                  optionLabel='name'
                                  dataKey='name'
                      ...
                      <div>
                        ...
                        <InputText value={model.preSnapIgnoredExitCodes}
                                   type='number'
                                   onChange={(e: any) => {
                                       setModel({
                                           ...model,
                      ...
                      <div>
                        <h4>Pre-snapshot command arguments (all space-separated arguments should be provided as separate arguments, first
                          argument is the executable)</h4>
                        <Chips value={model.preSnapCmdArgs} onChange={(e) => {
                            setModel({
                                ...model,
                ...
                <AccordionTab header='Post snapshot command execution'>
                  <div>
                    ...
                    <ToggleButton checked={model.postSnapCmdExecEnabled}
                                  onChange={(e) => {
                                      setModel({
                                          ...model,
                    ...
                    <div>
                      <div>
                        ...
                        <Dropdown value={model.postSnapStdErrorHandling}
                                  optionLabel='name'
                                  dataKey='name'
                                  options={preAndPostSnapStdErrorHandlingOptions}
                                  onChange={(e) => {
                      ...
                      <div>
                        ...
                        <InputText value={model.postSnapIgnoredExitCodes}
                                   type='number'
                                   onChange={(e: any) => {
                                       setModel({
                                           ...model,
                      ...
                      <div>
                        <h4>Post-snapshot command arguments (all space-separated arguments should be provided as separate arguments, first
                          argument is the executable)</h4>
                        <Chips value={model.postSnapCmdArgs} onChange={(e) => {
                            setModel({
                                ...model,
                ...
                <AccordionTab header='SSH access (for pre/post snapshot command execution)'>
                    ...
                    <div>
                        <h3>SSH key path</h3>
                        <InputText value={model.sshKeyPath}
                                   type='text'
                                   onChange={(e: any) => {
                                       setModel({
                                           ...model,
            ...
            <Accordion
                ...
                <AccordionTab header='Configure SSH password (for pre/post snapshot command execution)'>
                    <div>
                        <h3>SSH password</h3>
                        <InputText value={sshPassword.first}
                                   type='password'
                                   onChange={(e: any) => {
                                       setSshPassword({
                                           ...sshPassword,
                    ...
                    <div>
                        ...
                        <InputText value={sshPassword.second}
                                   type='password'
                                   onChange={(e: any) => {
                                       setSshPassword({
                                           ...sshPassword,
                    ...
                    <div className='d-flex justify-content-end mt-3'>
                        <div>
                            <Button label='Save'
                                    ...
                                    disabled={!sshPassword.first || (sshPassword.first !== sshPassword.second)}
