...
export const hypervisorManagerImportExportModes = {
  'AWS': [
    {name: 'DISK_ATTACHMENT', description: 'Disk attachment to proxy VM (full)'}
  ],
  'KUBERNETES': [
    {name: 'DISK_ATTACHMENT', description: 'Disk attachment to proxy VM (full)'}
  ],
  ...
  'RHV': [
    {name: 'DISK_ATTACHMENT', description: 'Disk attachment to proxy VM (full)'},
    {name: 'DISK_IMAGE_TRANSFER', description: 'Disk image transfer (full/incremental)'},
    {name: 'SSH_TRANSFER', description: 'SSH transfer'}
  ],
  'VCENTER': [
    {name: 'DISK_ATTACHMENT', description: 'Disk attachment to proxy VM (full)'}
...
export const hypervisorImportExportModes = [
  ...
  },
  {
    ...
    description: 'Separate disks (full/incremental) + Changed Block Tracking (incremental)'
  }
]
