...
export const selectSchedules = (store: RootState) => store.virtualMachine.schedules;
export const selectPolicies = (store: RootState) => store.virtualMachine.policies;
export const selectSnapshotPolicies = (store: RootState) => store.virtualMachine.snapshotPolicies;
